...
contract SygmaStateTest is Test {
    ...
    address public mockChecker1 =
        address(0x2222222222222222222222222222222222222222);
    address public mockChecker2 =
        address(0x3333333333333333333333333333333333333333);

    bytes32 public constant MOCK_TRANSACTION_GUID =
        keccak256("test_transaction");
    bytes32 public constant MOCK_TRANSACTION_GUID_2 =
    ...
    function test_OverwriteInsurance() public {
        ...
        SygmaTypes.SygmaTransaction memory transaction1 = SygmaTypes
            .SygmaTransaction({
                bridge: "LayerZero",
                transactionGuid: MOCK_TRANSACTION_GUID,
                fromAddress: address(0x1234),
        ...
        SygmaTypes.SygmaInsurance memory insurance1 = SygmaTypes
            .SygmaInsurance({
                usdAmount: 1000e18,
                premium: 10e18,
        ...
        SygmaTypes.SygmaTransaction memory transaction2 = SygmaTypes
            .SygmaTransaction({
                bridge: "Wormhole",
                transactionGuid: MOCK_TRANSACTION_GUID,
        ...
        SygmaTypes.SygmaInsurance memory insurance2 = SygmaTypes
            .SygmaInsurance({
                usdAmount: 2000e18,
                premium: 20e18,
    ...
    function test_AddMultipleInsurances() public {
        ...
        SygmaTypes.SygmaInsurance memory storedInsurance1 = state.getInsurance(
            MOCK_TRANSACTION_GUID
        );
        SygmaTypes.SygmaInsurance memory storedInsurance2 = state.getInsurance(
            MOCK_TRANSACTION_GUID_2
        );
    ...
    function test_InsurancePublicMapping() public {
        ...
        SygmaTypes.SygmaInsurance memory publicInsurance = state.getInsurance(
            MOCK_TRANSACTION_GUID
        );
    ...
    function testFuzz_SetChainReceiverChecker(
        uint32 chainId,
        address checker
    ) public {
